<?php
/**
 * Template Name: Funnel - Development
					...
					<div class="mbf-funnel__content">
						...
						<ul class="mbf-funnel__benefits" aria-label="<?php esc_attr_e( 'Product benefits', 'apparel' ); ?>">
							<li class="mbf-funnel__benefit">
								...
								<p><?php esc_html_e( 'Start with pre-built agent templates and ship new experiences in minutes.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Design and iterate across voice, chat, SMS, and WhatsApp from one developer-friendly studio.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Connect code, docs, and product data to deliver context-aware engineering support.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Deploy integrations that keep environments in sync faster than manual handoffs.', 'apparel' ); ?></p>
							</li>
						</ul>
						...
						<div class="mbf-funnel__trust">
							<p class="mbf-funnel__trust-label"><?php esc_html_e( 'Trusted by product and engineering teams worldwide', 'apparel' ); ?></p>
