<?php
/**
 * Template for Doc Subcategory taxonomy archives.
 *
 * @package Apparel
 */
...
$term_title    = $term ? $term->name : __( 'Documentation', 'apparel' );
...
<div class="docs-shell" data-docs-sidebar>
	...
	<main class="docs-main" id="primary" role="main">
		...
		<header class="docs-main__header">
			<h1 class="docs-main__title"><?php echo esc_html( $term_title ); ?></h1>
			<?php if ( ! empty( $term_desc ) ) : ?>
				<div class="docs-main__description"><?php echo wp_kses_post( wpautop( $term_desc ) ); ?></div>
			<?php endif; ?>
		</header>
		...
		<?php else : ?>
			<p class="docs-list__empty"><?php esc_html_e( 'No documentation available in this subcategory yet.', 'apparel' ); ?></p>
		<?php endif; ?>
	</main>
</div>
