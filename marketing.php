<?php
/**
 * Template Name: Funnel - Marketing
				...
				<div class="mbf-funnel__grid">
					<div class="mbf-funnel__content">
						<h1 id="mbf-funnel-heading" class="mbf-funnel__headline">
							<?php esc_html_e( 'Launch AI agents that capture leads and accelerate conversions', 'apparel' ); ?>
						</h1>
						...
						<ul class="mbf-funnel__benefits" aria-label="<?php esc_attr_e( 'Product benefits', 'apparel' ); ?>">
							<li class="mbf-funnel__benefit">
								...
								<p><?php esc_html_e( 'Use proven agent templates to launch high-converting campaigns fast.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Engage prospects on voice, chat, SMS, and WhatsApp from one campaign hub.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Personalize conversations with instant access to offers, pricing, and positioning.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Push qualified leads into your CRM pipeline automatically in real time.', 'apparel' ); ?></p>
							</li>
						</ul>
						...
						<div class="mbf-funnel__trust">
							<p class="mbf-funnel__trust-label"><?php esc_html_e( 'Trusted by growth and revenue teams worldwide', 'apparel' ); ?></p>
					...
					<aside class="mbf-funnel__form" aria-label="<?php esc_attr_e( 'Get access to your growth trial', 'apparel' ); ?>">
						<div class="mbf-funnel__form-card">
							<h2 class="mbf-funnel__form-title"><?php esc_html_e( 'Get access to your growth trial', 'apparel' ); ?></h2>
							<?php echo do_shortcode( '[fluentform id="FORM_ID_MARKETING"]' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
