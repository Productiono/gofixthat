...
:root {
	/* Base Font */
	--mbf-font-base-family: <?php mbf_typography( 'font_base', 'font-family', 'Manrope' ); ?>;
	--mbf-font-base-size: <?php mbf_typography( 'font_base', 'font-size', '1rem' ); ?>;
	--mbf-font-base-weight: <?php mbf_typography( 'font_base', 'font-weight', '600' ); ?>;
	...
	/* Primary Font */
	--mbf-font-primary-family: <?php mbf_typography( 'font_primary', 'font-family', 'Manrope' ); ?>;
	--mbf-font-primary-size: <?php mbf_typography( 'font_primary', 'font-size', '0.75rem' ); ?>;
	...
	/* Secondary Font */
	--mbf-font-secondary-family: <?php mbf_typography( 'font_secondary', 'font-family', 'Manrope' ); ?>;
	--mbf-font-secondary-size: <?php mbf_typography( 'font_secondary', 'font-size', '0.875rem' ); ?>;
	--mbf-font-secondary-weight: <?php mbf_typography( 'font_secondary', 'font-weight', '700' ); ?>;
	--mbf-font-secondary-style: <?php mbf_typography( 'font_secondary', 'font-style', 'normal' ); ?>;
	--mbf-font-secondary-letter-spacing: <?php mbf_typography( 'font_secondary', 'letter-spacing', 'normal' ); ?>;
	--mbf-font-secondary-text-transform: <?php mbf_typography( 'font_secondary', 'text-transform', 'none' ); ?>;

	/* Category Font */
	--mbf-font-category-family: <?php mbf_typography( 'font_category', 'font-family', 'Manrope' ); ?>;
	--mbf-font-category-size: <?php mbf_typography( 'font_category', 'font-size', '0.625rem' ); ?>;
	...
	/* Post Meta Font */
	--mbf-font-post-meta-family: <?php mbf_typography( 'font_post_meta', 'font-family', 'Manrope' ); ?>;
	--mbf-font-post-meta-size: <?php mbf_typography( 'font_post_meta', 'font-size', '0.75rem' ); ?>;
	...
	/* Input Font */
	--mbf-font-input-family: <?php mbf_typography( 'font_input', 'font-family', 'Manrope' ); ?>;
	--mbf-font-input-size: <?php mbf_typography( 'font_input', 'font-size', '0.75rem' ); ?>;
	...
	--mbf-font-post-subtitle-size: <?php mbf_typography( 'font_post_subtitle', 'font-size', '1.25rem' ); ?>;
	--mbf-font-post-subtitle-letter-spacing: <?php mbf_typography( 'font_post_subtitle', 'letter-spacing', 'normal' ); ?>;

	/* Post Content */
	--mbf-font-post-content-family: <?php mbf_typography( 'font_post_content', 'font-family', 'Manrope' ); ?>;
	--mbf-font-post-content-size: <?php mbf_typography( 'font_post_content', 'font-size', '1rem' ); ?>;
	--mbf-font-post-content-letter-spacing: <?php mbf_typography( 'font_post_content', 'letter-spacing', 'normal' ); ?>;
	--mbf-font-post-content-line-height: <?php mbf_typography( 'font_post_content', 'line-height', '1.6' ); ?>;

	/* Entry Excerpt */
	--mbf-font-entry-excerpt-family: <?php mbf_typography( 'font_excerpt', 'font-family', 'Manrope' ); ?>;
	--mbf-font-entry-excerpt-size: <?php mbf_typography( 'font_excerpt', 'font-size', '0.75rem' ); ?>;
	--mbf-font-entry-excerpt-weight: <?php mbf_typography( 'font_excerpt', 'font-weight', '700' ); ?>;
	--mbf-font-entry-excerpt-letter-spacing: <?php mbf_typography( 'font_excerpt', 'letter-spacing', 'normal' ); ?>;
	--mbf-font-entry-excerpt-line-height: <?php mbf_typography( 'font_excerpt', 'line-height', '1.4' ); ?>;
	...
	--mbf-font-footer-logo-size: <?php mbf_typography( 'font_footer_logo', 'font-size', '1.375rem' ); ?>;
	...
	/* Headings */
	--mbf-font-headings-family: <?php mbf_typography( 'font_headings', 'font-family', 'Manrope' ); ?>;
	--mbf-font-headings-weight: <?php mbf_typography( 'font_headings', 'font-weight', '500' ); ?>;
	--mbf-font-headings-style: <?php mbf_typography( 'font_headings', 'font-style', 'normal' ); ?>;
	--mbf-font-headings-line-height: <?php mbf_typography( 'font_headings', 'line-height', '1.2' ); ?>;
	--mbf-font-headings-letter-spacing: <?php mbf_typography( 'font_headings', 'letter-spacing', 'normal' ); ?>;
	...
	--mbf-font-menu-family: <?php mbf_typography( 'font_menu', 'font-family', 'Manrope' ); ?>;
	--mbf-font-menu-size: <?php mbf_typography( 'font_menu', 'font-size', '0.75rem' ); ?>;
	...
	--mbf-font-submenu-family: <?php mbf_typography( 'font_submenu', 'font-family', 'Manrope' ); ?>;
	--mbf-font-submenu-size: <?php mbf_typography( 'font_submenu', 'font-size', '0.75rem' ); ?>;
	--mbf-font-submenu-weight: <?php mbf_typography( 'font_submenu', 'font-weight', '700' ); ?>;
