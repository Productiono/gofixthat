...
if ( ! class_exists( 'MBF_Customizer_Fonts' ) ) {
	...
	final class MBF_Customizer_Fonts {
		...
		public static function get_all_variants() {
			return array(
				'100'       => esc_html__( 'Ultra-Light 100', 'apparel' ),
				'100light'  => esc_html__( 'Ultra-Light 100', 'apparel' ),
				'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'apparel' ),
				'200'       => esc_html__( 'Light 200', 'apparel' ),
				'200italic' => esc_html__( 'Light 200 Italic', 'apparel' ),
				'300'       => esc_html__( 'Book 300', 'apparel' ),
				'300italic' => esc_html__( 'Book 300 Italic', 'apparel' ),
				'400'       => esc_html__( 'Normal 400', 'apparel' ),
				'regular'   => esc_html__( 'Normal 400', 'apparel' ),
				'italic'    => esc_html__( 'Normal 400 Italic', 'apparel' ),
				'500'       => esc_html__( 'Medium 500', 'apparel' ),
				'500italic' => esc_html__( 'Medium 500 Italic', 'apparel' ),
				'600'       => esc_html__( 'Semi-Bold 600', 'apparel' ),
				'600bold'   => esc_html__( 'Semi-Bold 600', 'apparel' ),
				'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'apparel' ),
				'700'       => esc_html__( 'Bold 700', 'apparel' ),
				'700italic' => esc_html__( 'Bold 700 Italic', 'apparel' ),
				'800'       => esc_html__( 'Extra-Bold 800', 'apparel' ),
				'800bold'   => esc_html__( 'Extra-Bold 800', 'apparel' ),
				'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'apparel' ),
				'900'       => esc_html__( 'Ultra-Bold 900', 'apparel' ),
				'900bold'   => esc_html__( 'Ultra-Bold 900', 'apparel' ),
				'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'apparel' ),
			);
		}
