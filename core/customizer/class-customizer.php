	...
	class MBF_Customizer {
		...
		public function customizer_controls_enqueue_scripts() {
			...
			wp_localize_script( 'mbf-customizer', 'cscoCustomizerConfig', array(
				...
				'advanced_settings'    => esc_html__( 'Advanced settings', 'apparel' ),
				'noFileSelected'       => esc_html__( 'No File Selected', 'apparel' ),
				'remove'               => esc_html__( 'Remove', 'apparel' ),
				'default'              => esc_html__( 'Default', 'apparel' ),
				'selectFile'           => esc_html__( 'Select File', 'apparel' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'apparel' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'apparel' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'apparel' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'apparel' ),
			) );
