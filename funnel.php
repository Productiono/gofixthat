				...
				<div class="mbf-funnel__grid">
					<div class="mbf-funnel__content">
						<h1 id="mbf-funnel-heading" class="mbf-funnel__headline">
							<?php esc_html_e( 'Launch AI agents & automate your customer interactions', 'apparel' ); ?>
						</h1>
						...
						<ul class="mbf-funnel__benefits" aria-label="<?php esc_attr_e( 'Product benefits', 'apparel' ); ?>">
							<li class="mbf-funnel__benefit">
								...
								<p><?php esc_html_e( 'Access pre-built AI Agent templates. Deploy your Agent in minutes!', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Design custom Agents on Voice, Chat, SMS, WhatsApp with no-code Agent Studio.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Get context-aware Agents with 1-click integrations to your FAQs, product catalogs, policies.', 'apparel' ); ?></p>
							</li>
							<li class="mbf-funnel__benefit">
								<span class="mbf-funnel__icon" aria-hidden="true">
									<svg viewBox="0 0 24 24" role="presentation" focusable="false">
								...
								<p><?php esc_html_e( 'Enable Agents to instantly update to your systems using powerful integrations - faster than your human reps!', 'apparel' ); ?></p>
							</li>
						</ul>
						...
						<div class="mbf-funnel__trust">
							<p class="mbf-funnel__trust-label"><?php esc_html_e( 'Trusted by leading consumer brands worldwide', 'apparel' ); ?></p>
					...
					<aside class="mbf-funnel__form" aria-label="<?php esc_attr_e( 'Get access to your trial account', 'apparel' ); ?>">
						<div class="mbf-funnel__form-card">
							<h2 class="mbf-funnel__form-title"><?php esc_html_e( 'Get access to your trial account', 'apparel' ); ?></h2>
